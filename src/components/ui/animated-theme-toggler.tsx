...
export const AnimatedThemeToggler = ({
  ...
  const isDark = isControlled ? (theme === "dark" || (theme === "system" && document.documentElement.classList.contains("dark"))) : internalIsDark
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      // isDark logic needs to check the actual DOM class if theme is "system"
