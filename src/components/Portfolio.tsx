    ...
    <section id="portfolio" className="section-padding section-mesh relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="text-center mb-14">
          ...
          >
            <span className="tag tag-violet">Our Work</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <br />
            <SplitText className="text-gradient-mixed" text="real results" type="words" delay={0.4} />
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          className="relative rounded-3xl border border-violet-500/25 overflow-hidden mb-8"
        ...
        >
          ...
          <div className="flex items-center gap-3 px-7 pt-7 mb-6">
            <div className="flex items-center gap-2 bg-violet-500/10 border border-violet-500/20 rounded-xl px-4 py-2">
              ...
              <span className="text-violet-400 text-sm font-medium">In Production</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="px-7 pb-7">
              ...
              <div className="space-y-4 mb-6">
                <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/15">
                  <div className="text-red-400 text-xs font-semibold uppercase tracking-wider mb-2">The Challenge</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">{caseStudy.problem}</p>
                </div>
                <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/15">
                  <div className="text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-2">Our Solution</div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {caseStudy.stack.map((tech) => (
                    <span key={tech} className="text-xs font-medium px-3 py-1.5 rounded-lg border border-violet-500/20 text-violet-300"
            ...
            {/* Right: Visual mock */}
            <div className="relative p-7 flex items-center justify-center min-h-[300px]"
              ...
              <motion.div
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-20 h-3 bg-violet-500/40 rounded-full" />
                  ...
                  {/* Hero mock */}
                  <div className="rounded-xl bg-gradient-to-br from-violet-500/15 to-blue-500/10 p-4 border border-violet-500/20">
                    <div className="w-3/4 h-3 bg-white/20 rounded mb-2" />
                    <div className="w-1/2 h-2 bg-white/10 rounded mb-4" />
                    <div className="flex gap-2">
                      <div className="w-20 h-7 bg-violet-500/50 rounded-lg" />
              ...
              <div className="absolute top-4 right-4">
                <div className="bg-violet-500/20 border border-violet-500/30 rounded-xl px-3 py-2 text-xs text-violet-300 font-medium backdrop-blur-sm">
                  🚀 Launching Soon
                </div>
              </div>
            </div>
